#IMPORT NOTES
#Original file is located at https://colab.research.google.com/drive/1V52xU9y5Jh3iqCTf7yi5uAAu3iFDrQV3
...
cfg.width_range = (25,42) #(25,38)
cfg.height_range = (25,42) #(25,38)
...
cfg.wh_ratio_range = (0.3, 1.6) #(0.8, 1.2)
...
root = tkinter.Tk()
root.withdraw()
folder_path = fd.askdirectory(parent=root,initialdir="/Users/florianfurrer/Documents/GitHub/naw-omr",title='Please select a directory') #change to "folder_path"
...
# Boxdetect
  #for img in os.listdir(img_path):
    checkboxes = get_checkboxes(
      img_path, cfg=cfg, px_threshold=0.3, plot=False, verbose=True) #px_threshold=0.6 #threshold = Schwelle True/False
